...
def decrypt_key(encrypted_data: str, passphrase: str = "default_salt_2024") -> str:
    ...
    This must match the logic in your encrypt_key() / decrypt_key() helper.
    """
    ...
    try:
        ...
        # Don't leak key content; just log minimal info
...
# Use the same passphrase you used in the helper encryption script
...
def debug():
    ...
    return jsonify({
        ...
        "openai_client": "Available" if client else "Not Available (check API key / decryption)",
